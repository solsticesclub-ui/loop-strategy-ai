...
<div class="nav-wrap" id="nav">
  <div class="nav-pill">
    ...
    <ul class="nav-links">
      <li><a href="/visualisation">Services</a></li>
      <li><a href="/visualisation#portfolio">Portfolio</a></li>
      <li><a href="/visualisation#visualization-pricing">Pricing</a></li>
      <li><a href="/visualisation#faq">FAQ</a></li>
    </ul>
...
<div class="mobile-menu" id="mobileMenu">
  ...
  <a href="/visualisation" onclick="document.getElementById('mobileMenu').classList.remove('open')">Services</a>
  <a href="/visualisation#portfolio" onclick="document.getElementById('mobileMenu').classList.remove('open')">Portfolio</a>
  <a href="/visualisation#visualization-pricing" onclick="document.getElementById('mobileMenu').classList.remove('open')">Pricing</a>
  <a href="/visualisation#faq" onclick="document.getElementById('mobileMenu').classList.remove('open')">FAQ</a>
</div>
<main>
